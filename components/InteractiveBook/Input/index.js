...
const BiCollabCreator = ({ navigation,route }) =>{
      ...
      uploadTask.on("state_changed",
        ...
        () => {
          ...
          .then(async(downloadURL) => {
            ...
            await bicollabBackend.CreateBicollab(convName,downloadURL,members,typeConv,currentUserLogged,versionSelected,'fr')
            .then((id)=>{
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{minWidth:'90%',gap:10,padding:5}}>
          ...
          <View style={{flex:1,flexDirection:'column',gap:10}}>
            ...
            <Text style={styleFont.subtitle}>Sélectionne la version que tu souhiates étudier</Text>
...
export default BiCollabCreator;